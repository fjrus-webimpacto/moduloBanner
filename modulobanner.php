...
class ModuloBanner extends Module
{
    ...
    protected function renderForm()
    {
            ...
            'tinymce' => true,
            'legend' => array(
                'title' => $this->l('Opciones del banner'),
                 ),
                'input' => array(
                       'id_banner' => array(
                       'type' => 'hidden',
                       ...
                       array(
                           ...
                           'name' => 'id_category',
                           'desc' => $this->l('Seleccione la posicion donde desea inserta el banner '),
                           'options' => array(
                        ...
                        'lang' => true,
                        'name' => 'imagen',
                        'desc' => $this->l('Seleccione la imagen que desea mostrar '),
                        'display_image' => true,
                        'size' => $image_size,
    ...
    {
                $sql = 'SELECT ba.`id_banner`, ba.`id_category`, ba.`hook`, ca.`name`
                FROM `'._DB_PREFIX_.'banners` ba 
                LEFT JOIN `'._DB_PREFIX_.'category_lang` ca ON ba.`id_category` = ca.`id_category` 
    ...
    public function hookDisplayTopColumn($params)
    {
        if (Tools::getValue('controller') == 'category') {
            ...
            if (!empty($valor)) {
                ...
                return $this->display(__FILE__, 'views\templates\admin\hook\front\api\modulobanner.tpl');
            }
        }
    }
